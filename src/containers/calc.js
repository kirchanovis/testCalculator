    ...
    return (
      <div className="calc">
        ...
        <div className="buttons"> 
          <Button onClick={() => this.props.clear() } addClass="button_action" label="C"  />
          ...
          <Button onClick={() => this.props.add('/')} addClass="button_action" label="/" />
          ...
          <Button onClick={() => this.props.add('-')} addClass="button_action" label="-" />
          <Button onClick={() => this.props.add('+')} addClass="button_action" label="+" size="2" />
          <Button onClick={() => this.props.calculate()} addClass="button_action" label="=" size="2" />
        </div>
      </div>
    )
  }
